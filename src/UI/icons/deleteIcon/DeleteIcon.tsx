...
const DeleteIcon = ({ className, clickHandler, withBackground }: Props) => {
	const classNames = [className ? `${className}__delIcon delIcon` : `delIcon`]
	if (withBackground) {
		classNames.push('delIcon--dark')
	}
	return (
		<div
